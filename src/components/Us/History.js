    ...
    return (
        <div>
            ...
            <div className="oval">
                ...
                <h2 id="mid">Compromiso <hr width="1" size="20" /> <hr width="1" size="12" /> <hr width="1" size="2" /></h2>
                <h2>Crecimiento <hr width="1" size="20" /> <hr width="1" size="12" /> <hr width="1" size="2" /></h2>
            </div>
        </div>
