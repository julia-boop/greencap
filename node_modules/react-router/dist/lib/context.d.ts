import * as React from "react-router/dist/lib/node_modules/react";
import type { AgnosticRouteMatch, AgnosticIndexRouteObject, AgnosticNonIndexRouteObject, History, Location, RelativeRoutingType, Router, StaticHandlerContext, To, TrackedPromise, LazyRouteFunction } from "react-router/dist/lib/node_modules/@remix-run/router";
import type { Action as NavigationType } from "react-router/dist/lib/node_modules/@remix-run/router";
...
export declare const DataRouterStateContext: React.Context<import("react-router/dist/lib/node_modules/@remix-run/router").RouterState | null>;
